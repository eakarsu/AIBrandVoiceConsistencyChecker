    ...
    <div style={styles.layout}>
      <header style={styles.header}>
        ...
        <div style={styles.headerRight}>
          ...
          <button onClick={() => navigate('/claim-substantiation')} style={{ ...styles.logoutBtn, background: 'rgba(34, 197, 94, 0.1)', borderColor: 'rgba(34, 197, 94, 0.2)', color: '#86efac' }} title="Claim Substantiation">
            <FileCheck size={18} />
          </button>
