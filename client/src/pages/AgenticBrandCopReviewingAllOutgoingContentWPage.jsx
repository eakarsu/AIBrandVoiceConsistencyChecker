...
export default function AgenticBrandCopReviewingAllOutgoingContentWPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-agentic-brand-cop-reviewing-all-outgoing-content-w/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>Agentic brand-cop reviewing all outgoing content with explainable scores</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-agentic-brand-cop-reviewing-all-outgoing-content-w/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
