...
export default function RagOverTheBrandSStyleGuideForInlineGuidanPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-rag-over-the-brand-s-style-guide-for-inline-guidan/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>RAG over the brand's style guide for inline guidance in editor plugins</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-rag-over-the-brand-s-style-guide-for-inline-guidan/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
